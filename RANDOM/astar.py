...
def capture(board, n, r, q, player):
    capture = []
    # put your code here
    if player == "red":
            ...
            if board[r-1][q+1] == 2:
                if board[r-1][q] == 2:
                    if board[r-2][q+1] == 1:
                        capture.append((r-1,q+1))
                        capture.append((r-1,q))  
        if r > 0 and q > 0 and q+1 < n:  
            if board[r-1][q] == 2:
                if board[r][q-1] == 2:
                    if board[r-1][q-1] == 1:
                        capture.append((r-1,q))
                        capture.append((r,q-1))
        if q-1 > 0 and r+1 < n and q+1 < n:
            if board[r][q-1] == 2:
                if board[r+1][q-1] == 2:
                    if board[r+1][q-2] == 1:
                        capture.append((r,q-1))
        ...
        if r+1 < n and q > 0 and q+1 < n:
            if board[r+1][q-1] == 2:
                if board[r+1][q] == 1:
                    if board[r][q+1] == 2:
                        capture.append((r+1,q-1))
                        capture.append((r,q+1))
        if r+1 < n and r > 0 and q+1 < n:
            if board[r+1][q] == 2:
                if board[r][q+1] == 1:
                    if board[r-1][q+1] == 2:
                        capture.append((r+1,q))
            ...
            if board[r][q+1] == 2:
                if board[r-1][q+1] == 1:
                    if board[r-1][q] == 2:
                        capture.append((r,q+1))
                        capture.append((r-1,q))
        if q > 0 and r > 0 and q+1 < n:
            if board[r-1][q+1] == 2:
                if board[r-1][q] == 1:
                    if board[r][q-1] == 2:
                        capture.append((r-1,q+1))
                        capture.append((r,q-1))
        if r > 0 and r+1 < n and q > 0:
            if board[r-1][q] == 2:
                if board[r][q-1] == 1:
                    if board[r+1][q-1] == 2:
                        capture.append((r-1,q))
