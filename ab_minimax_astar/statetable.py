""" 
The tranposition table module was modified for alpha-beta players, and the source code 
is from:
 https://github.com/duilio/c4/blob/master/c4/cache.py
and
https://github.com/williamcorsel/hexai/blob/main/hexai/transpositiontable.py
"""
import numpy as np
...
class TranspositionTable():
    ...
    def store(self, depth, state, move, score):
        ...
        """
        if state not in self.move_list:
