...
Original file modified with some extra utility functions for sample solution.
"""
...
def add_coords(a, b):
    """
    Utility function to add two coordinates.
    ...
    Returns:
        Summed component-wise coord tuple (r, q).
    """
